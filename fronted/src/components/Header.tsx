...
export default function Header({ navigate, currentPage, favCount }: Props) {
  ...
  return (
    <header
      style={{ background: 'rgba(8,14,28,0.95)', backdropFilter: 'blur(12px)', borderBottom: '1px solid #2A2A2A' }}
        ...
        <div className="flex items-center gap-4">
          ...
          <form onSubmit={handleSearch} className="hidden md:flex flex-1 max-w-xl items-center gap-2">
            <div className="relative flex-1">
              ...
              />
              <button type="submit" className="absolute right-2 top-1/2 -translate-y-1/2 text-muted hover:text-prime transition-colors">
