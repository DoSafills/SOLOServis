      ...
      <Breadcrumb
        items={[
          ...
          },
          {
            ...
            onClick: () =>
              navigate({ id: "search-products", query: product.category }),
          },
          { label: product.name },
        ]}
      />
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mt-1 flex-wrap">
                    ...
                    >
                      -
                      {Math.round(
                        (1 - product.offerPrice / cheapestAvailable.price) *
                          100,
                      )}
                      % OFF
                    </span>
                    <span className="text-xs text-muted">
                      Ahorro:{" "}
                      {formatPrice(
                        cheapestAvailable.price - product.offerPrice,
                      )}
                    </span>
                  </div>
                </div>
