...
const genHistory = (basePrice: number, days: number): Array<{ date: string; price: number }> => {
  const points = []
  const now = new Date()
  for (let i = days; i >= 0; i -= Math.ceil(days / 30)) {
    ...
    points.push({ date: d.toISOString().split('T')[0], price: Math.round(variation / 1000) * 1000 })
  }
  return points
}

/** Generate a sparse offer-price history (promotions happen only a few times per year) */
const genOfferHistory = (basePrice: number): Array<{ date: string; price: number }> => {
  const now = new Date()
  const promos = [
  ...
  return promos.map(({ daysAgo, discount }) => {
    ...
    return { date: d.toISOString().split('T')[0], price: Math.round(basePrice * (1 - discount) / 1000) * 1000 }
  })
}
...
export const products: Product[] = [
  {
    ...
    category: 'Tecnología',
    subcategory: 'Gaming',
    image: 'https://images.unsplash.com/photo-1591489378430-ef2f4c626b35?w=600&h=400&fit=crop&auto=format',
    images: [
    ...
    description: 'La RTX 4060 de ASUS con diseño dual fan ofrece rendimiento excepcional en gaming 1080p con tecnología DLSS 3.',
    rating: 4.6,
    reviewCount: 342,
    specs: {
      'VRAM': '8GB GDDR6',
    ...
    offers: [
      { storeId: 'techzone', storeName: 'TechZone', price: 299990, available: true, shipping: 0 },
      { storeId: 'megapc', storeName: 'MegaPC', price: 309990, available: true, shipping: 5990 },
      { storeId: 'infoplex', storeName: 'InfoPlex', price: 319990, available: false, shipping: 7990 },
      { storeId: 'digitalstore', storeName: 'DigitalStore', price: 304990, available: true, shipping: 0 },
    ],
  ...
  },
  {
    ...
    description: 'La RTX 4060 Ti de MSI con 16GB de VRAM, ideal para contenido creativo y gaming 1440p con máximos detalles.',
    rating: 4.8,
    reviewCount: 218,
    specs: {
      'VRAM': '16GB GDDR6',
    ...
    offers: [
      { storeId: 'techzone', storeName: 'TechZone', price: 449990, available: true, shipping: 0 },
      { storeId: 'megapc', storeName: 'MegaPC', price: 459990, available: true, shipping: 0 },
      { storeId: 'digitalstore', storeName: 'DigitalStore', price: 444990, available: true, shipping: 0 },
    ],
  ...
  },
  {
    ...
    category: 'Tecnología',
    subcategory: 'Gaming',
    image: 'https://images.unsplash.com/photo-1624705002806-5d72df19c3ad?w=600&h=400&fit=crop&auto=format',
    images: [
      'https://images.unsplash.com/photo-1624705002806-5d72df19c3ad?w=600&h=400&fit=crop&auto=format',
    ],
    description: 'La alternativa AMD de alto valor con 8GB GDDR6. Excelente para gaming 1080p y edición de video ligera.',
    rating: 4.4,
    reviewCount: 187,
    specs: {
      'VRAM': '8GB GDDR6',
    ...
    offers: [
      { storeId: 'techzone', storeName: 'TechZone', price: 259990, available: true, shipping: 0 },
      { storeId: 'infoplex', storeName: 'InfoPlex', price: 269990, available: true, shipping: 7990 },
      { storeId: 'megapc', storeName: 'MegaPC', price: 264990, available: false, shipping: 5990 },
    ],
  ...
  },
  {
    ...
    description: 'Notebook gaming con i7 de 13ª gen y RTX 4060. Pantalla 144Hz IPS y 16GB RAM DDR5. Relación precio-rendimiento excepcional.',
    rating: 4.5,
    reviewCount: 456,
    specs: {
    ...
    offers: [
      { storeId: 'techzone', storeName: 'TechZone', price: 849990, available: true, shipping: 0 },
      { storeId: 'digitalstore', storeName: 'DigitalStore', price: 839990, available: true, shipping: 0 },
      { storeId: 'megapc', storeName: 'MegaPC', price: 869990, available: true, shipping: 0 },
      { storeId: 'infoplex', storeName: 'InfoPlex', price: 879990, available: false, shipping: null },
    ],
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1697051897520-8d7d0f77ab8f?w=600&h=400&fit=crop&auto=format',
    images: [
      'https://images.unsplash.com/photo-1697051897520-8d7d0f77ab8f?w=600&h=400&fit=crop&auto=format',
    ],
    description: 'iPhone 15 con chip A16 Bionic, Dynamic Island, cámara principal de 48 MP y conector USB-C.',
    rating: 4.7,
    reviewCount: 1204,
    specs: {
    ...
    offers: [
      { storeId: 'techzone', storeName: 'TechZone', price: 749990, available: true, shipping: 0 },
      { storeId: 'digitalstore', storeName: 'DigitalStore', price: 739990, available: true, shipping: 0 },
      { storeId: 'megapc', storeName: 'MegaPC', price: 759990, available: true, shipping: 5990 },
    ],
  ...
  },
  {
    ...
    description: 'Galaxy S25 con Snapdragon 8 Elite, cámara de 50 MP y Android 15. Integración avanzada con Galaxy AI.',
    rating: 4.6,
    reviewCount: 876,
    specs: {
    ...
    offers: [
      { storeId: 'techzone', storeName: 'TechZone', price: 829990, available: true, shipping: 0 },
      { storeId: 'infoplex', storeName: 'InfoPlex', price: 819990, available: true, shipping: 0 },
      { storeId: 'digitalstore', storeName: 'DigitalStore', price: 839990, available: false, shipping: null },
    ],
...
export const services: Service[] = [
  ...
  },
  {
    ...
    category: 'Internet',
    subcategory: 'Fibra óptica',
    description: 'Plan fibra óptica 600 Mbps con router Wi-Fi 6 y hasta 5 dispositivos conectados simultáneamente.',
    monthlyPrice: 22990,
  ...
  },
  {
    ...
    description: 'Plan móvil con 100 GB de datos, llamadas ilimitadas y roaming en Latinoamérica incluido.',
    monthlyPrice: 14990,
  ...
  },
  {
    ...
    category: 'Streaming',
    subcategory: 'Video',
    description: 'Acceso ilimitado a series, películas y documentales en calidad 4K Ultra HD. Hasta 4 pantallas simultáneas.',
    monthlyPrice: 17990,
    installationCost: null,
    contractMonths: null,
    rating: 4.5,
