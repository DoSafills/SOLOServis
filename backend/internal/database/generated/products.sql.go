...
type ListProductsRow struct {
	...
	Rating       pgtype.Numeric   `json:"rating"`
	ReviewCount  int64            `json:"review_count"`
	OfferStoreID pgtype.Int4      `json:"offer_store_id"`
	OfferStoreName pgtype.Text    `json:"offer_store_name"`
	OfferPrice   pgtype.Numeric   `json:"offer_price"`
	OfferShippingCost pgtype.Numeric `json:"offer_shipping_cost"`
	OfferShippingFree pgtype.Bool `json:"offer_shipping_free"`
	OfferAvailable pgtype.Bool    `json:"offer_available"`
	OfferProductUrl pgtype.Text   `json:"offer_product_url"`
}
